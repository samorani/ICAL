...
namespace OtherSolvers
{
    public class CPP_InstanceGenerator
    {
        ...
        public CPP_InstanceGenerator(int seed, double minW, double maxW, double marginCapacity,
        ...
        public CCP_ProblemInstance GenerateInstance(int n, int p)
        {
            ...
            return new CCP_ProblemInstance(n, p, c, weights, L, U);
        }
    }
}
